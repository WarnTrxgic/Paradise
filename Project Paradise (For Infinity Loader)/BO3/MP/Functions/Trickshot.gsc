    ...
    slide()
    {
        ...
        self.spawnedSlide setModel("wpn_t7_care_package_world");
    ...
    doSpawnOption(selection)
    {
        switch(selection)
        {
            ...
            if (isDefined(self.spawnedTrampoline))
            {
                ...
                self.spawnedTrampoline setModel("wpn_t7_care_package_world");
            ...
            { 
                ...
                for(d = -3; d < 3; d++)
                {
                    ...
                    self.spawnedplat[i][d] setModel("wpn_t7_care_package_world");
            ...
            self.spawnedcrate setModel("wpn_t7_care_package_world");
