    LoadSettings()
    {
        ...
        self.presets["R"] = int( self LoadPreset( "menuColorRed", "168" ) );
        self.presets["G"] = int( self LoadPreset( "menuColorGreen", "14" ) );
        self.presets["B"] = int( self LoadPreset( "menuColorBlue", "78" ) );
