    ...
    enableFlips()
    {
        if( self getPlayerCustomDvar( "allowFlips" ) == "1")
        {
            ...
            WriteInt(0x83761688, 0x428C0000);
            WriteInt(0x83761644, 0x428C0000);
        }
        else
        {
            self setPlayerCustomDvar( "allowFlips", "1" );
            WriteInt(0x83761688, 0x7FC00000); //player_view_pitch_down
            WriteInt(0x83761644, 0x7FC00000); //player_view_pitch_up
        }
    }
