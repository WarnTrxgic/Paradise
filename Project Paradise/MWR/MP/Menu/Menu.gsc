    menuOptions()
    {
        ...
        switch(menu)
        {
            ...
            {
                tpNames = "Roof 1;Roof 2;Roof 3; Water Tower; Roof 4";
                tpCoords = [
                    (-3324.6, 1091, 209),
                    (3333.45, 286.406, 262),
                    (-3611.36, 545.334, 215),
            ...
            {
                tpNames = "Roof 1;Roof 2;Highway Sign;Roof 3";
                tpCoords = [ 
                    (1210.42, 352.161, 460),
                    (1514.04, -612.295, 408),
                    (5985.11, 4013.33, 795),
            ...
            {
                tpNames = "Arch Barrier;Roof 1;Roof 2;Roof 3";
                tpCoords = [
            ...
            {
                tpNames = "Barn Roof 1;Barn Roof 2;Roof 1";
                tpCoords = [
                    (4657.43, 2267.37, 762),
            ...
            {
                tpNames = "Pipe Pillar;Warehouse Rafters";
                tpCoords = [
                    (2439.66, 6253.07, 989),
                    (841.095, 786.229, 399)
                ];
            ...
            {
                tpNames = "Roof Ledge 1;Roof Ledge 2;Roof Ledge 3";
                tpCoords = [
            ...
            for( i = 1; i < 369; i++ )
                self addOpt(CamoNameTable(i), ::equip_camo, i);
            break;
