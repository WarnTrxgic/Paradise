      ...
      <div class="content">
        ...
        <div class="card features">
            <ul>
                ...
                <li>Almost Hit Tracking</li>
                <li>Wallbang Everything</li>
                <li>Custom "ragebait" Messages</li>
                <li>Automatic Bot Spawning</li>
                <li>Supports FFA/SND/TDM</li>
                <li>Public Match & Private Match</li>
                <li>+ More!</li>
            </ul>
        </div>
